package com.dev.jaeder42.devwatch
 ...
 */
class DevWatch : CanvasWatchFaceService() {

    override fun onCreateEngine(): Engine {
        return Engine()
    }

    private class EngineHandler(reference: DevWatch.Engine) : Handler() {
        private val mWeakReference: WeakReference<DevWatch.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(WatchFaceStyle.Builder(this@DevWatch)
        ...
        private fun initializeWatchFace() {
            ...
            mWatchHandColor = ContextCompat.getColor(baseContext, R.color.yellow)
            mWatchHandHighlightColor =ContextCompat.getColor(baseContext, R.color.pink)
            mWatchHandShadowColor =ContextCompat.getColor(baseContext, R.color.off_blue)
        ...
        private fun drawDate(canvas: Canvas){
            if(!mAmbient) {
                ...
                val rec = Rect(mCenterX.toInt() + 80, mCenterY.toInt() + 20, mCenterX.toInt() + 120, mCenterY.toInt() - 20)
                val paint = Paint()
                paint.color = ContextCompat.getColor(baseContext, R.color.dark_blue)

                canvas.drawRect(rec, paint)

                paint.color = ContextCompat.getColor(baseContext, R.color.mint)
                val a = currentDate
                paint.typeface = Typeface.DEFAULT
                paint.textSize = 30.0f
                canvas.drawText(a.toString(), mCenterX + 82f, mCenterY+10f, paint)
            }
        }
        ...
        private fun drawBackground(canvas: Canvas) {
            ...
            if (mAmbient) {
                canvas.drawColor(ContextCompat.getColor(baseContext, R.color.black))
            } else {
                canvas.drawColor(ContextCompat.getColor(baseContext, R.color.blue))
            }
        }
        ...
        private fun registerReceiver() {
            ...
            this@DevWatch.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@DevWatch.unregisterReceiver(mTimeZoneReceiver)
        }
